...
func TestFunctionObject(t *testing.T) {
	...
	if len(fn.Parameters) != 1 {
		t.Fatalf("wrong parameters lengths, want=%d, got=%d", 1, len(fn.Parameters))
	}
...
func TestStringLiteral(t *testing.T) {
	...
	evaluated := testEval(input)
	literal, ok := evaluated.(*object.String)
	if !ok {
		t.Fatalf("literal is not a *object.String, got=%T", evaluated)
	}
...
func TestBuiltinFunctions(t *testing.T) {
	...
	for _, tt := range tests {
		...
		case string:
			errObj, ok := evaluated.(*object.Error)
			if !ok {
				t.Errorf("object is not *object.Error, got=%T", evaluated)
				continue
			}

			if errObj.Message != expected {
				t.Errorf("wrong errObj.Message, want %q, got=%q", expected, errObj.Message)
				continue
			}
		case *object.Null:
...
func TestArrayLiterals(t *testing.T) {
	...
	if !ok {
		t.Fatalf("object is not *object.Array, got=%T", evaluated)
	}

	if len(result.Elements) != 3 {
		t.Fatalf("array has wrong number of elements, want 3 got=%d", len(result.Elements))
	}
...
func TestHashLiterals(t *testing.T) {
	...
	if len(result.Pairs) != len(expected) {
		t.Fatalf("Hash has wrong number of pairs, want 6 got=%d", len(result.Pairs))
	}
...
func testIntegerObject(t *testing.T, evaluated object.Object, expected int64) bool {
	...
	if !ok {
		t.Errorf("object is not an integer, got=%T", evaluated)
		return false
	}

	if result.Value != expected {
		t.Errorf("value did not equal expected, want=%d, got=%d", expected, result.Value)
		return false
	}
...
func testBooleanObject(t *testing.T, evaluated object.Object, expected bool) bool {
	...
	if !ok {
		t.Errorf("object is not a boolean, got=%T", evaluated)
		return false
	}

	if result.Value != expected {
		t.Errorf("value did not equal expected, want=%t, got=%t", expected, result.Value)
		return false
	}
...
func testNullObject(t *testing.T, obj object.Object) bool {
	if obj != NULL {
		t.Errorf("obj not NULL, got=%T", obj)
		return false
	}
